...
class Verzameling extends React.Component {
  componentDidMount() {
      ...
      >
        ...
        <div className="collection-use-echtezalm">
          ...
          <p className="collection-use-echtezalm-text">
            ...
            vestibulum malesuada lorem egestas non id. Amet, tincidunt quisque
            et non tincidunt pellentesque. Erat laoreet nisl sed dignissim sit
            est nulla. Id purus, quis porta quis. Sit in nisl viverra nam nulla
...
export default connect(null, { addToCart })(Verzameling);
